...
export default function Footer() {
  return (
    <footer className="border-t border-surface-border bg-surface-dark/80">
      <div className="container-xl py-16">
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-6 sm:gap-8 lg:gap-12">
          {/* Brand */}
          <div className="col-span-2 sm:col-span-3 md:col-span-2">
            <Link to="/" className="group flex items-center mb-4 w-fit" aria-label="NavMe home">
              <BrandLogo
                size="md"
            ...
            <p className="text-sm text-gray-400 leading-relaxed max-w-xs mb-5">
              Discover AR experiences near you. Location-based AR navigation for the modern world.
            </p>
            ...
            <div className="flex items-center gap-3">
              {SOCIALS.map(({ label, href, icon }) => (
                <a
                  ...
                  aria-label={label}
                  className="w-9 h-9 rounded-lg bg-surface-card border border-surface-border flex items-center justify-center text-gray-400 hover:text-brand-400 hover:border-brand-500/40 transition-all duration-200"
                >
                  {icon}
                </a>
              ))}
        ...
        <div className="mt-12 pt-6 border-t border-surface-border flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-xs text-gray-500">
            &copy; {new Date().getFullYear()} NavMe. All rights reserved.
          </p>
